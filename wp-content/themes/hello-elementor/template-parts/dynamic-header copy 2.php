...
.sub-menu-lists li:hover #html-show {
	display: block;
}
.d-noness {
	display: none;
												...
												?>
													<div class="col-md-4 col-lg-4 col-sm-4">
														<li>
															...
															<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="menus-main"><path d="M201.4 342.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 274.7 86.6 137.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z"/></svg>
															<?php if($submenu_level2){ ?>
																<ul id="html-show">
																	...
																	<li>
																		...
																		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="menus-mainl3"><path d="M201.4 342.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 274.7 86.6 137.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z"/></svg>
																			...
																			<ul class="d-noness">
																				...
																				?>
																						<li>
																							...
																							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="menus-mainl4"><path d="M201.4 342.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 274.7 86.6 137.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z"/></svg>
